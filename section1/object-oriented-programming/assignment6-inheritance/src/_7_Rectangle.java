...
public class _7_Rectangle {
    ...
    public static void main( String[] args ) {
        ...
        MyRectangle2D r3 = new MyRectangle2D( 1.1, 1, 1, 1 );
        ...
        System.out.printf("r2.contains(r1) is %b\n", r2.contains( r1 ));
        System.out.printf("r2.contains(r3) is %b\n\n", r2.contains( r3 ));

        System.out.printf("r3.contains(r1) is %b\n", r3.contains( r1 ));
        System.out.printf("r3.contains(r2) is %b\n\n", r3.contains( r2 ));

        System.out.printf("r1.overLaps(r2) is %b\n", r1.overLaps( r2 ));
        System.out.printf("r1.overLaps(r3) is %b\n\n", r1.overLaps( r3 ));

        System.out.printf("r2.overLaps(r1) is %b\n", r2.overLaps( r1 ));
        System.out.printf("r2.overLaps(r3) is %b\n\n", r2.overLaps( r3 ));

        System.out.printf("r3.overLaps(r1) is %b\n", r3.overLaps( r1 ));
        System.out.printf("r3.overLaps(r2) is %b\n", r3.overLaps( r3 ));
...
class MyRectangle2D {
    ...
    public boolean contains( double x, double y ) {
        ...
        double x0_OfRectangle = this.x - this.width / 2;
        double x1_OfRectangle = this.x + this.width / 2;
        double y0_OfRectangle = this.y - this.height / 2;
        double y1_OfRectangle = this.y + this.height / 2;

//        System.out.printf("%f %f %f %f\n", x0_OfRectangle, x1_OfRectangle, y0_OfRectangle, y1_OfRectangle);
//        System.out.printf(" x to check = %f  y to check = %f \n", coordinateToCheck[0], coordinateToCheck[1]);
    ...
    public boolean overLaps( MyRectangle2D r ) {
        ...
        return  contains( c0_r2[0], c0_r2[1] ) ||
                contains( c1_r2[0], c1_r2[1] ) ||
                contains( c2_r2[0], c2_r2[1] ) ||
                contains( c3_r2[0], c3_r2[1] );
    }
