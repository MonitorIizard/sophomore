...
public class _8_RectangleAndLine {
    public static void main( String[] args ) {
        ...
        Rectangle c = new Rectangle( 5, 5, 2.5, 0 );
        ...
        System.out.printf("Is rectangle b overlap rectangle c ? %b\n", Rectangle.overLaps(b, c) );
...
class Rectangle extends MyRectangle2D {
    ...
    public static boolean overLaps( Rectangle a, Rectangle b ) {
        ...
        double x0_OfRectangle2 = a.getX() - a.getWidth() / 2;
        double x1_OfRectangle2 = a.getX() + a.getWidth() / 2;
        double y0_OfRectangle2 = a.getY() - a.getHeight() / 2;
        double y1_OfRectangle2 = a.getY() + a.getHeight() / 2;
        ...
        return  b.contains( c0_r2[0], c0_r2[1] ) ||
                b.contains( c1_r2[0], c1_r2[1] ) ||
                b.contains( c2_r2[0], c2_r2[1] ) ||
                b.contains( c3_r2[0], c3_r2[1] );
    }
}
